    ...
    <section sx={{ variant: 'section.services'}}>
      <Container sx={styles.containerBox}>
        <Box sx={styles.thumbnail}>
          ...
          <Button sx={styles.videoBtn} onClick={handleClick} arial-label="Play Button">
            <span><IoIosPlay/></span>
          </Button>
          <Box sx={styles.shapeBox}>
            <Image sx={shapePattern} alt="shape"/>
          </Box>
        </Box>
      ...
      <ModalVideo channel="youtube" isOpen={videoOpen} videoId="oxFr7we3LC8"
